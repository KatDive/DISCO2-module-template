...
void module()
{
    ...
    for (int i = 0; i < num_images; ++i)
    {
        ...
        //TODO: update values after Odense experiment
        float black_level = 64.0f;
        float white_level = 1023.0f;
        ...
        for (int y = 0; y < height; ++y)
        {
            for (int x = 0; x < width; ++x)
            {
                for (int c = 0; c < channels; ++c)
                {
                    ...
                    float normalized = (float) pixel_value - black_level;
                    ...
                    output_image_data[pixel_index] = (unsigned char)(normalized * 255.0f); //FIXME is this correct?
                }
            }
        }
        ...
        // TODO ask Robert about freeing memory
